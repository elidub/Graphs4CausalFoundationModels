...
def main():
    ...
    CONFIG_PATH = Path(__file__).parent.parent.parent.parent / "experiments" / "GraphConditioning" / "configs_5node_benchmarked" / "lingaus_5node_benchmarked_gcn_and_hartatt.yaml"
