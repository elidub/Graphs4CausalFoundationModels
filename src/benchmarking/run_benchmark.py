...
def main(args):
    loader = SimpleOpenMLLoader(data_dir=args.data_dir, use_target_encoding=not args.no_target_encoding, verbose=not args.quiet)
    ...
    for tid in tasks:
        ...
        try:
            ...
            if not args.quiet:
                print(f"Task {tid} RMSE — LR: {rmse_lr:.4f}, RF: {rmse_rf:.4f}, PFN: {rmse_pfn}")
...
if __name__ == "__main__":
    ...
    CHECKPOINT = "/fast/arikreuter/DoPFN_v2/CausalPriorFitting/experiments/FirstTests/checkpoints/early_test1_1e5lr/final.pt"
    DEVICE = "cuda"
