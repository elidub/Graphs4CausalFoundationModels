...
class ComplexMechBenchmarkNTest:
    """
    Benchmark class for graph-conditioned interventional models with partial graph knowledge.
    
    This class handles the ComplexMechNTest benchmark with three-state adjacency matrices {-1, 0, 1}
    ...
    def __init__(
        self,
        benchmark_dir: str = "/fast/arikreuter/DoPFN_v2/CausalPriorFitting/experiments/GraphConditioning/Benchmarks/ComplexMechNTest",
    ...
    def quick_benchmark(
        ...
        Example:
            >>> benchmark = ComplexMechBenchmarkNTest(max_samples=100)
...
if __name__ == "__main__":
    ...
    print("ComplexMechBenchmarkNTest - Full Benchmark")
    print("="*80)
    ...
    print("  benchmark = ComplexMechBenchmarkNTest(max_samples=100, use_ancestor_matrix=False)")
    ...
    print("  benchmark_anc = ComplexMechBenchmarkNTest(max_samples=100, use_ancestor_matrix=True)")
