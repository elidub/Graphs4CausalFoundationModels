"""
Generate benchmark datasets for LinGaus benchmark.
...
from experiments.GraphConditioning.Benchmarks.LinGausIDK.LingausBenchmarkIDK import LinGausBenchmark
...
def main():
    ...
    print("="*80)
    print("LinGaus Benchmark Data Generation")
    print("="*80)
    print(f"\nConfiguration:")
    ...
    print("  python LingausBenchmark.py")
    print("  # or use the LinGausBenchmark class programmatically")
    print("="*80)
