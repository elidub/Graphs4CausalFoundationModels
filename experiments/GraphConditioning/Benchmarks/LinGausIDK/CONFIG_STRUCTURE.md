# LinGausIDK Final Configuration Structure

## Overview

The LinGausIDK benchmark now has **96 configuration files** organized in a hierarchical structure:
...
- Base: `lingaus_idk_{N}node_base`
- Path variants: `lingaus_idk_{N}node_{variant}_hide{fraction}`

Examples:
- `lingaus_idk_5node_base`
- `lingaus_idk_5node_path_TY_hide0.5`
- `lingaus_idk_20node_path_independent_TY_hide1.0`
