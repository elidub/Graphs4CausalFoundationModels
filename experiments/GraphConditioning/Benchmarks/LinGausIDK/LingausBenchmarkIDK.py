...
class LinGausBenchmarkIDK:
    ...
    This class handles the LinGausIDK benchmark with three-state adjacency matrices {-1, 0, 1}
    ...
    def __init__(
        self,
        benchmark_dir: str = "/fast/arikreuter/DoPFN_v2/CausalPriorFitting/experiments/GraphConditioning/Benchmarks/LinGausIDK",
...
if __name__ == "__main__":
    ...
    print("LinGausBenchmarkIDK - Full Benchmark")
    print("="*80)
