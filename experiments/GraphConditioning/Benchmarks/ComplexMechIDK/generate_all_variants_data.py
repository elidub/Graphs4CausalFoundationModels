...
def main():
    ...
    print("="*80)
    print("ComplexMechIDK Benchmark - All Variants Data Generation")
    print("="*80)
    print(f"\nConfiguration:")
        ...
        for variant in args.variants:
            if variant == "base":
                ...
                for hide_fraction in args.hide_fractions:
                    ...
                    output_filename = f"complexmech_{node_count}nodes_{variant}_hide{hide_fraction}_{args.num_samples}samples_seed{args.base_seed}.pkl"
                    output_path = cache_dir / output_filename
