...
if __name__ == "__main__":
    ...
    checkpoint_path = "<REPO_ROOT>/experiments/FirstTests/checkpoints/final_earlytest_5node_16773270.0/final.pt"
    model_config_path = "<REPO_ROOT>/experiments/FirstTests/checkpoints/final_earlytest_5node_16773270.0/final_config.yaml"
