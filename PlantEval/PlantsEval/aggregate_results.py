...
# Configuration
RESULTS_DIR = "/fast/arikreuter/DoPFN_v2/CausalPriorFitting/PlantEval/PlantsEval/results"
DATASETS = ["CID_10_ints_10_reals_normal"]
METRICS = ["mise", "amise"]

# Dataset information
DATASET_INFO = {
    "CID_10_ints_10_reals_normal": {"n_train": 256, "n_test": 1000, "n_features": 9, "n_realizations": 10},
}
